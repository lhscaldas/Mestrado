...
if __name__ == "__main__":
    root_path = "results/NDT_AGO_OUT"  # Substitua pelo caminho real dos seus dados
    method = "vwcd"  # Substitua pelo nome do método que você deseja processar
    # merge_csv_metrics(root_path, method)
    series_path = "series/NDT_AGO_OUT"  # Substitua pelo caminho real dos seus dados de séries temporais
